...
class NSC_BLOG_FONT_AWESOME_ICON_PICKER extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $nsc_blog_font_awesome_icon_array = nsc_blog_font_awesome_icon_array();
...
if(!function_exists('nsc_blog_font_awesome_icon_array')){
    function nsc_blog_font_awesome_icon_array(){
