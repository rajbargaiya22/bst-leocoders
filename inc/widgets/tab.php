...
class NSC_Tabbed_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        ?>
        <div class="nsc-tabbed-widget">
            <ul class="nsc-tabs">
                <li class="active">
                  <a href="#nsc-news" title="<?php echo esc_attr('News'); ?>">
                ...
                <li>
                  <a href="#nsc-tags" title="<?php echo esc_attr('Tags'); ?>">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  <a href="#nsc-comments" title="<?php echo esc_attr('Comments'); ?>">
            ...
            <div class="nsc-tab-content" id="nsc-news">
                ...
                <div class="nsc-tab-contentt">
                    ...
                    if ($latest_posts->have_posts()) { // Check if there are any posts
                        while ($latest_posts->have_posts()) {
                            ...
                            ?>
                        <div class="nsc-tab-post d-flex align-items-center gap-1">
                          <span class="d-block">
                            ...
                            <a href="<?php the_permalink(); ?>" class="nsc-post-title" title="<?php the_title(); ?>"><?php the_title(); ?></a><br>
                        </div>
                        <?php
                        }
            ...
            <div class="nsc-tab-content" id="nsc-tags" style="display: none;">
                <!-- Code for displaying tags -->

                <div class="nsc-tag-content">
                    <?php
                    $tags = get_tags(array(
...
// Register the widget
function nsc_load_tabbed_widget() {
    register_widget('NSC_Tabbed_Widget');
}
