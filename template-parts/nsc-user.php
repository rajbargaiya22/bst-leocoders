      ...
      global $wp_roles;
       ...
       if (!empty($assigned_roles)) {
           foreach ($assigned_roles as $role => $name) {
               ...
               <div class="nsc-author-container">
               <?php
                 foreach ($users as $user) { ?>
                   <div class="text-center">
                     ...
                     <p class="nsc-authorname mb-0 mt-4"><?php echo esc_html($user->display_name) ?></p>

                     <?php if (get_user_meta($user->ID, 'nsc_blog_user_location', true) != ''): ?>
                       <span class="nsc-author-location"><?php echo get_user_meta($user->ID, 'nsc_blog_user_location', true); ?></span>
                     <?php endif; ?>
