...
')); ?></p>
                            <div class="review__item__author-name"><?php echo esc_html(get_theme_mod('rj_bst_leo_testimonial_1_author', 'Lauren Golf, Programmer')); ?></div>
                        	</div>
